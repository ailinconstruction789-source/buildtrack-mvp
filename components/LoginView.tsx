  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-4">
      {dialogConfig.isOpen && (
        <div className="fixed inset-0 z-[500] bg-black/30 backdrop-blur-xl flex items-center justify-center p-4">
          <div className="bg-white rounded-[2rem] shadow-2xl max-w-sm w-full p-6 text-center space-y-4">
            ...
            <h3 className="text-xl font-bold">{dialogConfig.title}</h3>
            <p className="text-[#86868b] font-medium">{dialogConfig.message}</p>
      ...
      <div className="bg-white p-6 sm:p-12 rounded-[2.5rem] shadow-2xl w-full max-w-md border border-slate-100 relative overflow-hidden">
        ...
        <h1 className="text-4xl font-bold text-[#1d1d1f] italic uppercase tracking-tighter mb-2 text-center relative z-10">BuildTrack</h1>
