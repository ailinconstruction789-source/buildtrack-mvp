...
const newShellLines = `      <div className={\`\${isMobilePreview ? 'w-[390px] h-[844px] bg-background border-[14px] border-outline rounded-[3rem] shadow-elevation-3 relative overflow-hidden flex flex-col' : 'flex h-screen w-full overflow-hidden'} print:hidden\`}>
...
// lines 1320 (index 1319) to 1810 (index 1809)
lines.splice(1319, 1809 - 1319 + 1, newShellLines);

fs.writeFileSync(targetFile, lines.join('\n'));
console.log('Shell replaced successfully by line numbers!');
